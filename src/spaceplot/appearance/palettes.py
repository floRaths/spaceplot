...
set25b = ['#7CB342', '#A16CFD', '#FF7043', '#008FFF', '#0C8668',
          '#FFCA28', '#BC29AE', '#28EDED', '#D32F2F', '#FFBAFF']
...
gemstone = ['#bcc7ee', '#8263b1', '#6fe3d4', '#00c7ad', '#f19900', '#c75e0c', '#b1abb4', '#8b6f8b', '#96bbba', '#4b877a']
